...
% This should explain the monitoring process that will be used and the type of remedial actions that could be put in place if required. Does the institute have an approved code of practice covering monitoring procedures?
...
%In terms of the wider research environment, I am working with Dr Sanne Cottaar (University of Cambridge) as co-developers of the BurnMan project \citep{CHRU2014}, an open-source thermoelastic and thermodynamic toolkit. I have set up a collaboration on synthetic waveform generation with Dr Stefanie Hempel (ISAE Toulouse), which will feed in to WP3 and WP4 of this project. 
